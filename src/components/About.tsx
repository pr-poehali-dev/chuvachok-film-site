            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="font-open-sans text-gray-600 leading-relaxed">
                  "Чувачок Продакшн" родилась из страсти к кинематографу и
                  желания рассказывать истории, которые важны. Мы начинали как
                  небольшая команда энтузиастов и выросли в полноценную студию.
                </p>
              </div>
            </div>
