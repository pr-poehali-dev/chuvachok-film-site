  ...
  const teamMembers = [
    {
      ...
      description:
        "Юная основательница студии, всего 12 лет. Режиссёр и актриса одновременно.",
      icon: "Crown",
    },
    {
      name: "Рощин Саша",
      role: "Основатель, актёр",
      description: "Второй юный основатель студии, 13 лет. Талантливый актёр.",
      icon: "Star",
    },
    {
      ...
      role: "Актёр, режиссёр",
      description:
        "Молодой актёр 11 лет, уже проявил себя в качестве режиссёра.",
      icon: "Camera",
    },
    {
      name: "Влад Горковенко",
      role: "Актёр",
      description: "Актёр 10 лет и младший брат Миши.",
      icon: "Users",
    },
    {
      name: "Тимофей Щур",
      role: "Актёр, оператор",
      description: "Актёр и оператор 14 лет, самый старший и опытный в группе.",
      icon: "Video",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Юные таланты от 10 до 14 лет, которые создают настоящее
